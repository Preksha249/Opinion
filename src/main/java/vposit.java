...
public class vposit extends JFrame {
	...
	public vposit() {
		setAlwaysOnTop(true);
		setBackground(UIManager.getColor("infoText"));
		...
		Image img = new ImageIcon(this.getClass().getResource("/veryhappy.png")).getImage();
		lblNewLabel.setIcon(new ImageIcon(img));		
		lblNewLabel.setBounds(106, 12, 408, 316);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("AWESOME");
