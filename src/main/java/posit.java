...
public class posit extends JFrame {
	...
	public posit() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/happy.png")).getImage();
		lblNewLabel.setIcon(new ImageIcon(img));		
		lblNewLabel.setBounds(106, 12, 408, 316);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("HAPPY");
		lblNewLabel_1.setForeground(new Color(0, 153, 51));
